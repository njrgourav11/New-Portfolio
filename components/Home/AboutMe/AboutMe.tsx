          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Gourav, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet.   My journey in computer science began in 2021 when I delved into the world of full-stack development. Starting with the basics of HTML, CSS, and JavaScript, I quickly realized the potential of creating dynamic and responsive web applications. As I expanded my knowledge to include frameworks like React and backend technologies such as Node.js and Firebase, I became passionate about building comprehensive web solutions. This marked the start of my journey as a full-stack developer, driven by a desire to continuously learn and innovate in the ever-evolving tech landscape.

              </span>
            </div>
            <div className="font-Header ">
            <span className="text-gray-400 ">
  Since pursuing my engineering degree, my career has spanned diverse industries, allowing me to refine my expertise in both desktop and web development. I am passionate about creating innovative and user-friendly solutions using modern technologies. One of my notable projects includes developing the NIST website and a faculty dashboard, enhancing communication and data management for over 20,000 users. My experience also includes working on impactful projects for organizations like JIRDS, an NGO, where I developed a comprehensive website to increase awareness of their services. With a dedication to continuous learning and improvement, I strive to deliver high-quality solutions that make a positive impact.
</span>
